...
// Auto-generated by Convert on 2025-10-08 14:46:02
...
String createHTML() {
  ...
  str += "            background-color: var(--backDarkMid);\n";
  str += "            border-radius: 16px;\n";
  str += "            display:flex;\n";
  str += "            height:100%;\n";
  str += "            flex-direction: column;\n";
  ...
  str += "            }\n";
  str += "            const disblable = {\n";
  str += "                btn1:getElementById(eStopBtn)\n";
  str += "            }\n";
  str += "            const traffic = {\n";
  ...
  str += "                }\n";
  str += "            }\n";
  str += "//TODO add statuses\n";
  str += "            function renderStatus() {\n";
  str += "                document.getElementById('status').textContent = 'Status: { }'\n";
  str += "            }\n";
  str += "\n";
  str += "            function poll() {\n";
  str += "                fetch('/state')\n";
  ...
  str += "    </header>\n";
  str += "    <main> \n";
  str += "        <div class=\"sideBar\" style=\"align-self:flex-start\">\n";
